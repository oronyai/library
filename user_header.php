...
<header class = "sticky">
    ...
    <nav class = "navbar">
        <ul>
            <li>
                <a href="user_page.php" class="links">HOME</a>
            </li>
            <li>
                <a href="user_display.php" class="links">BOOKS LIST</a>
            </li>
            <li>
                <a href = "user_borrowed.php" class="links">BORROWED</a>
            </li>

            <li>
                <div class = "forum-button-container">
                    <button class="forum-button" name="forum" onclick="showComment()">
                        <a href="user_page.php#comment">FORUM</a></button>
                </div>
            </li>
                ...
                <ul class = "submenu">
                    <li> 
                        <form action="user_update.php" method="POST" enctype="multipart/form-data">
                            <button class = 'pop-up-btn'><a href  = 'user_update.php?update=$id'>Update Profile</a></button>
                        </form>
                    </li>
                    <li>
                        <form action="user_background.php" method="POST" enctype="multipart/form-data">
                            <button type='submit' class='pop-up-btn'><a href="user_background.php">Background</a></button>
                        </form> 
                    </li>
                    <li>
                        <form action="user_header.php" method="POST" enctype="multipart/form-data">
    ...
    <div id = "comment">
        <form method="POST" action="user_header.php">
            <?php
                require_once ('config.php');
                ...
                echo "<button style='margin-left: 10px'>
                    <a href='user_forum.php' style='text-decoration:none; color:black;'>
                    Make Post
                </a></button>";

...
<head>
    ...
    <style>
        .page-container{
            ...
            width: 1000px;
            height: 100vhpx;
            background-image: url('user_background/<?php echo $bg_img; ?>');
...
<form action="admin_background.php" method="POST" enctype="multipart/form-data">
    <button type='submit' class='update-bg-btn'><a href="admin_background.php">Update Background Pic</a></button>
</form>   

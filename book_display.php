...
<div class="page-container">
    <div class="formcontainer">
        <button class="counter"><u>BOOK STATS</u> <br>
            ...
            <a href = "book_borrowed.php" class = "book_stats">Borrowed
                <?php  
                    require_once ('config.php');
            ...
            <a href = "approve_book.php" class = "book_stats">Requested
                <?php  
                    require_once ('config.php');
                        ...
                        foreach($result as $items){
                            echo "<div class='book-container'>";
                                ...
                                echo "<button class='view'><a class='action-link' href='bookFiles/".$row['title']."' target='_blank'>View</a></button>
                                    <button class='delete'><a class='action-link' href='book_delete.php?deleteid=$id'>Delete</a></button>";
                                echo "</div>";
                            echo "</div>";
                        }
                    }
    ...
    <div>
        ...
        <div class = "formcontainer">
            <form action="book_display.php" method="POST" enctype="multipart/form-data">
                
            <button class = "addBtn"><a href="book_form.php">Add Book</a></button>
            </form>

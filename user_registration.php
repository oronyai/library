...
<body>
    <div class = "container">
        ...
        <form class = "form" style = "text-align: center;" action = "user_registration.php" method = "POST" enctype="multipart/form-data">
...
<?php
    ...
    //Other details
        ...
        $upload_folder = "user_profile/" . $new_name;
        ...
        if(mysqli_num_rows(mysqli_query($conn, $enrolsql)) > 0){
            echo "<script>
                window.location.href = 'user_registration.php'; alert('Error! Enrollment Number already registered')
            </script>";
        }
        else{

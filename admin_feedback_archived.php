...
<div class = "page-container"><br><br>
    ...
    <div class="grid-container">
        ...
        <div class="user-container">
            ...
            <?php echo "</div>"; ?>
            <div class="action">
                <form action="admin_feedback_archived.php" method="POST">
    ...
    <button onclick = "document.location='admin_feedback.php'" class = "view-all-comment-link">View unread comments</button>
</div>

...
<body>
    <div class = "container">
        ...
        <hr>
        <form class = "form" style ="text-align: center;" action ="admin_login.php" method ="POST">
            ...
            <a href= "admin_passwordReset.php" class="login-link">Forgot password?</a><br>

            <p>Don't have an account? <a href="admin_registration.php" class="login-link"> Register</a></p>
...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<script>
                window.location.href = 'admin_login.php'; alert('Error! Please check your credentials')
            </script>";
        }
    }

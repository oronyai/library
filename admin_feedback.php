...
<div class = "page-container"><br><br>
    ...
    <button onclick = "document.location='admin_feedback_archived.php'" class = "view-all-comment-link">View archived comments</button>
</div>
...
<?php
    ...
    if (isset($_POST['read'])){
        ...
        if($result){
            echo "<script>
                window.location.href = 'admin_feedback.php'; alert('Comment Archived!')
            </script>";
        }
    }
    ...
    if (isset($_POST['delete'])){
        ...
        if($result){
            echo "<script>
                window.location.href = 'admin_feedback.php'; alert('Comment Deleted!')
            </script>";
        }
    }
?>
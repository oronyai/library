...
<header class = "sticky">
    ...
    <nav class = "navbar">
        <ul>
            <li><a href="admin_page.php" class="links">HOME</a></li>
            <li><a href="book_display.php"
                style="font-size: 15px;" class="links">BOOKS LIST</a></li>
            <li><a href = "book_borrowed.php" class="links">BORROWED</a></li>
            <li>
        ...
        <div class = "update-container">
            ...
            <button class="update-button" name="feedback"><a href="admin_feedback.php">Feedback(s)
                <?php  
                    require_once ('config.php');
        ...
        <form method="POST" action="header.php">
            <?php
                ...
                echo "<button style='margin-left: 10px'>
                    <a href='admin_forum.php' style='text-decoration:none; color:black;'>
                    Make Post
                </a></button>";
    ...
    <div id = "notice">
        <form method = "POST" action = "admin_header.php">
            <?php
                require_once ('config.php');

...
<body>
    <div class = "container">
        ...
        <form class = "form" style = "text-align: center;" action = "admin_connect.php" method = "POST">
            ...
            <p>Already have an account? <a href= "admin_login.php" class="login-link"> Login</a></p>
        </form>

                ...
                if($row > 0){
                    foreach($result as $items){
                        echo "<div class='book-container'>";
                            ...
                            echo " <button class='borrow'><a class='action-link' href='user_borrow.php?borrowid=$id'>Borrow</a></button>";
                            echo "</div>";
                        echo "</div>";
                    }
                }
            ...
            if(($_SESSION["user-login"]) == true) {
                ...
                echo "<div class='book-container'>";
                    ...
                    echo "<div class='action'>";
                        ...
                        echo "<button class='read'><a class='action-link' href='bookFiles/".$row['book_title']."' target='_blank'>Read</a></button>";
                    echo "</div>";
                echo "</div>";
                } else {
                    echo "<div class='book-container'>";
                        echo "<div class='bookArray'>";
                            echo "<img src='covers/" . $cover . "'style='width: 150px; height:200px'><br>";
                        echo"</div>";

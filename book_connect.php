...
//Book cover
        ...
        if($result){
            echo "<script>
                window.location.href ='book_form.php'; alert('Book registered successfully')
            </script>";
        } else {
            echo "<script>
                window.location.href ='book_form.php'; alert('Book upload failed')
            </script>";
        }
    }
...
//Book cover
        ...
        if($result){
            echo "<script>
                window.location.href ='book_display.php'; alert('Book updated successfully')
            </script>";
        } else {
            echo "<script>
                window.location.href ='book_display.php'; alert('Book update failed')
            </script>";
        }
    }
?>